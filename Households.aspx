<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Households.aspx.cs" Inherits="TV" %>
                    ...
                    <div class="collection-content col">
                        <div class="page-main-content">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="top-banner-wrapper">
                                       <!-- <a href="#"><img src="../assets/women.jpg" class="img-fluid blur-up lazyload" alt=""></a>-->
                                        <div class="top-banner-content small-section">
                                            <h4>Product Category</h4>
                                            <h5>Household</h5>
                                            <p> Elevate your everyday living with our diverse assortment of plastic household products designed to enhance convenience and organization within your home. From storage solutions and kitchenware to utility items, our household range combines functionality with style to simplify and enrich your domestic spaces.</p>
                                        </div>
                                    </div>
                                    <div class="collection-product-wrapper">
                                        <div class="product-top-filter">
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="footer-end">
                            <p><i class="fa fa-copyright" aria-hidden="true"></i> 2024 powered by E-Kisan Website</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12">
