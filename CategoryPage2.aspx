<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CategoryPage2.aspx.cs" Inherits="WomensCategory" %>
                                    ...
                                    <div class="top-banner-wrapper">
                                        <div class="top-banner-content small-section">
                                           <h4>Product Category</h4>
                                            <h5>Crops</h5>
                                            <p>The "Crops" section of the e-Kisan e-commerce platform offers a comprehensive range of crop varieties categorized into cereals, pulses, vegetables, fruits, oilseeds, spices, and cash crops. Each crop listing includes vital details such as ideal growing conditions, seasonality, expected yield, pest and disease management strategies, nutritional value, cultural practices, and post-harvest handling techniques. 
</p>
                                        </div>
                                    </div>
                                    <div class="collection-product-wrapper">
