<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CategoryPage4.aspx.cs" Inherits="WomensCategory" %>
                        ...
                        <div class="col-lg-6">
                            <div class="header-contact">
                                <ul>
                                 ...
                                 <li><i class="fa fa-phone" aria-hidden="true"></i>Call Us: 876725310</li>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="Default.aspx"><img src="../assets/E-Kissan.png" class="img-fluid blur-up lazyload" alt=""></a>
                                </div>
                                <div class="brand-logo">
   ...
   <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">PRODUCT <span class="caret"></span></a>
    <ul class="dropdown-menu" role="menu">
       <li><a href="CategoryPage.aspx">
           <asp:Label ID="Label58" runat="server" ></asp:Label></a></li>
       <li><a href="CategoryPage2.aspx">
           <asp:Label ID="Label59" runat="server" ></asp:Label></a></li>
                                                ...
                                                <li>
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <a href="#">
                                                                <h4>
                                                                    <asp:Label ID="Label26" runat="server" ></asp:Label></h4>
                                                            </a>
                                                            <h4><span>
                                                                <asp:Label ID="Label27" runat="server" ></asp:Label></span></h4>
                                                        </div>
                                                    </div>
                            ...
                            <div class="offer-slider slide-1">
                                <div>
                                    ...
                                    <div class="media">
                                        ...
                                        <a href="IndividualProductPage.aspx?ID=<%= id12 %>">
                                                <h6>
                                                    <asp:Label ID="Label46" runat="server" ></asp:Label></h6>
                                            </a>
                                            <h4>
                                                <asp:Label ID="Label47" runat="server" ></asp:Label></h4>
                                        </div>
                                    </div>
                                  ...
                                  <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            ...
                                            <a href="IndividualProductPage.aspx?ID=<%= id13 %>">
                                                <h6>
                                                    <asp:Label ID="Label48" runat="server" Text="Label"></asp:Label></h6>
                                            </a>
                                            <h4>
                                                <asp:Label ID="Label49" runat="server" Text="Label"></asp:Label></h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="top-banner-wrapper">
                                        <div class="top-banner-content small-section">
                                           <h4>Product Category</h4>
                                            <h5>Fertilizer</h5>
                                            <p>A fertilizer is any material of natural or synthetic origin that is applied to soil or to plant tissues to supply plant nutrients. Fertilizers may be distinct from liming materials or other non-nutrient soil amendments. Many sources of fertilizer exist, both natural and industrially produced.For most modern agricultural practices, fertilization focuses on three main macro nutrients: nitrogen (N), phosphorus (P), and potassium (K) with occasional addition of supplements like rock flour for micronutrients.</p>
                                        </div>
                                    </div>
                                    <div class="collection-product-wrapper">
                                        <div class="product-top-filter">
                        ...
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                <ul class="contact-list">
                                    <li><i class="fa fa-map-marker"></i>E-Kisan Website,At Post-Miraj, Taluka-Miraj, Dist-Sangli.
                                    </li>
                                    <li><i class="fa fa-map-marker"></i>Dist. Miraj, Maharashtra,India. </li>
