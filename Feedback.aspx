<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeFile="Feedback.aspx.cs" Inherits="ContactUs" %>
   ...
   <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">PRODUCT <span class="caret"></span></a>
    ...
    <!-- header end -->
        <div class="collection-content col">
            ...
            <img src="../assets/Feedback1.jpg" alt="" class="bg-img blur-up lazyload" style="width:100%;height:400px;margin:0px; padding:0px">
            <div class="container">
                <div class="row">
                    <div class="col">
    ...
    <form id="form1" runat="server">
        ...
        <%--    <div>
            ...
            <%--  <div>
                ...
                <asp:TextBox ID="txtMessage" runat="server" CssClass="form-input"></asp:TextBox>
            </div>--%>
            <div>
                <label for="txtMessage">Feedback:</label>
                <asp:TextBox ID="txtFeedback" runat="server" TextMode="MultiLine" Rows="5" CssClass="form-input"></asp:TextBox>
            </div>
            <div>

              <div>
    <label for="Rating">Rating:</label>
    <asp:DropDownList ID="Rating" runat="server" CssClass="form-input">
        <asp:ListItem Value=""></asp:ListItem>
        <asp:ListItem Value="1 Stars">1 Star</asp:ListItem>
        <asp:ListItem Value="2 Stars">2 Stars</asp:ListItem>
        <asp:ListItem Value="3 Stars">3 Stars</asp:ListItem>
        <asp:ListItem Value="4 Stars">4 Stars</asp:ListItem>
        <asp:ListItem Value="5 Star">5 Stars</asp:ListItem>
    </asp:DropDownList>
</div>
