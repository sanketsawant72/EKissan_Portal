<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CategoryPage3.aspx.cs" Inherits="WomensCategory" %>
                                    ...
                                    <div class="top-banner-wrapper">
                                        <div class="top-banner-content small-section">
                                           <h4>Product Category</h4>
                                            <h5>Equipment</h5>
                                            <p>
The e-Kisan e-commerce platform doesn't just stop at seeds and crops; it also offers a comprehensive range of farming equipment essential for modern agricultural practices. From tractors of various sizes suitable for different farm operations to harvesters designed to efficiently gather crops like wheat, rice, and sugarcane, farmers can find a diverse array of tools tailored to their needs. Plows and tillage equipment prepare the soil for planting, while seeders and planters ensure precise and uniform seeding. 
</p>
                                        </div>
                                    </div>
                                    <div class="collection-product-wrapper">
