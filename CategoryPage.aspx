                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact">
                            <ul>
                                <li>Welcome to E-Kisan Website</li>
                                 <li><i class="fa fa-phone" aria-hidden="true"></i>Call Us: 8767255310</li>
                                    ...
                                    <div class="top-banner-wrapper">
                                       <div class="top-banner-content small-section">
                                           <h4>Product Category</h4>
                                            <h5>Seeds    </h5>
                                            <p>
The e-Kisan project aims to provide a platform for farmers to buy and sell agricultural products online. In the seeds category, farmers can find various types of seeds for different crops. Here's some information you might find in the seeds category of the e-Kisan project.
</p>
                                        </div>
                                    </div>
                                    <div class="collection-product-wrapper">
                            ...
                            <div class="footer-contant">
                                <ul class="contact-list">
                                   <li><i class="fa fa-map-marker"></i>E-Kisan Website,At Post-Miraj, Taluka-Miraj, Dist-Sangli.
                                    ...
                                    <li><i class="fa fa-map-marker"></i>Dist. Sangli, Maharashtra,India. </li>
                                  
                                    <li><i class="fa fa-envelope"></i>Email:                                 <li><i class="fa fa-envelope"></i>Email: prathneshm804@gmail.com</li>
</li>
